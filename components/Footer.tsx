        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: "Search Flights", href: "#results" },
          ...
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <a
                ...
                className="inline-block bg-[#c9a94e] hover:bg-[#b8983d] text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-colors"
              >
                Email Us
              </a>
            </div>
